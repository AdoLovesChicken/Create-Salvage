package com.elitemastereric.createmelting.compat.jei;

import com.elitemastereric.createmelting.CreateMelting;
import com.elitemastereric.createmelting.SalvagingRecipeTypes;
import com.elitemastereric.createmelting.compat.jei.category.SalvagingCategory;
...
public class CreateMeltingJEI implements IModPlugin {
    private static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(CreateMelting.MODID, "jei_plugin");
