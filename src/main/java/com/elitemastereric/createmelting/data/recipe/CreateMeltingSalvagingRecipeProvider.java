...
import com.elitemastereric.createmelting.api.data.recipe.SalvagingRecipeGen;
import com.elitemastereric.createmelting.content.salvaging.SalvagingRecipeParams;
...
public final class CreateMeltingSalvagingRecipeProvider extends SalvagingRecipeGen {
    /**
     * SALVAGE MATERIALS
     */
    ...
    public CreateMeltingSalvagingRecipeProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
        super(output, registries, CreateMelting.MODID);
    }
